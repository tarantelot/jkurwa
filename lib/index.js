var models = require('./models/index.js'),
    ...
    fetch_certificates = require('./util/fetch_certificates.js'),
    check_password = require('./util/check_password.js'),
    _end;
...
module.exports = {
    ...
    Box: Box,
    fetch_certs: fetch_certificates.fetch,
    getUserInfo: fetch_certificates.getUserInfo,
    isPasswordCorrect: check_password.isPasswordCorrect,
    models: models,
};
